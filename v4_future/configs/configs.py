...
def get_configs():
    parser = argparse.ArgumentParser(
        description="GenVAD v4 — Future Frame Prediction (UCSD / Avenue)"
    )
    ...
    parser.add_argument("--output_dir", type=str, default="./v4_outputs")
    ...
    parser.add_argument(
        ...
        help="train_eval = antrenare + evaluare test; eval = doar inferență.",
    )
    parser.add_argument(
        "--resume",
        type=str,
        default="",
        help="Checkpoint .pth pentru eval sau continuare antrenare.",
    )
    ...
    parser.add_argument(
        "--eval_each_epoch",
        action="store_true",
        help="Rulează AUC pe test după fiecare epoch (mai lent).",
    )
